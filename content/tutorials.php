...
echo "<div class=\"column1-unit\">";
	...
	echo "<ul>";
		...
		echo "<li><img src=\"img/flags/United-States.png\" alt=\"".$template['index']['english']."\" title=\"".$template['index']['english']."\" />&nbsp;<a href=\"$dpath/AOS_Vol00_Language_introduction_en.pdf\">Vol 00</a>: ".$template['tutorials']['tree1c'].", ".$template['tutorials']['madeby']." <a href=\"mailto:cle [at] virg0 [dot] org\">etherea`</a></li><br />";
		...
		echo "<li><img src=\"img/flags/United-States.png\" alt=\"".$template['index']['english']."\" title=\"".$template['index']['english']."\" />&nbsp;<a href=\"$dpath/AOS_Vol01_Cycles_conditions_and_aliases_en.pdf\">Vol 01</a>: ".$template['tutorials']['tree1d'].", ".$template['tutorials']['madeby']." <a href=\"mailto:cle [at] virg0 [dot] org\">etherea`</a></li><br />";
		...
		echo "<li><img src=\"img/flags/United-States.png\" alt=\"".$template['index']['english']."\" title=\"".$template['index']['english']."\" />&nbsp;<a href=\"$dpath/AOS_Vol02_Arrays_dictionaries_objects_and_classes_en.pdf\">Vol 02</a>: ".$template['tutorials']['tree1e'].", ".$template['tutorials']['madeby']." <a href=\"mailto:cle [at] virg0 [dot] org\">etherea`</a></li><br />";
		...
		echo "<li><img src=\"img/flags/United-States.png\" alt=\"".$template['index']['english']."\" title=\"".$template['index']['english']."\" />&nbsp;<a href=\"$dpath/AOS_Vol03_Events_and_popups_en.pdf\">Vol 03</a>: ".$template['tutorials']['tree1f'].", ".$template['tutorials']['madeby']." <a href=\"mailto:cle [at] virg0 [dot] org\">etherea`</a></li><br />";
		...
		echo "<li><img src=\"img/flags/United-States.png\" alt=\"".$template['index']['english']."\" title=\"".$template['index']['english']."\" />&nbsp;<a href=\"$dpath/AOS_Vol04_Graphical_objects_and_layout_en.pdf\">Vol 04</a>: ".$template['tutorials']['tree1g'].", ".$template['tutorials']['madeby']." <a href=\"mailto:sykes [at] dubh [dot] id.au\">sykes</a></li><br />";

...
foreach($aItemsToList as $aItem)
{
	...
	//echo "						<a href=\"".$szScreenshotPath."/".$aItem["screen"]."\"><img src=\"".$szIconPath."/".$aItem["thumb"]."\" border=\"0\"></a>\n";
	echo "						<img src=\"".$szIconPath."/".$aItem["icon"]."\" border=\"0\">\n";
	echo "					</div>\n";
	echo "				</td>\n";
	echo "				<td valign=\"top\">\n";

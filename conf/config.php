...
$themes=array(
	...
	array("name" => "DarkBaghira", "version" => "0.1.2", "mail" => "hellvis69@netsons.REMOVE.THE.ANTISPAM.WORDS.org", "author" => "HelLViS69", "desc" => $template['themes']['theme10'], "home" => "http://hellvis69.netsons.org", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/DarkBaghira-0.1.2.tar.bz2", "screen" => "theme_darkbaghira.jpg", "thumb" => "thumb_darkbaghira.png"),
...
$tools=array(
	...
	array("name" => "KVIrc TCL", "author" => array("HelLViS69","CtrlAltCa"), "mail" => array("hellvis69@netsons.REMOVE.THE.ANTISPAM.WORDS.org","ctrlaltca@gmail.REMOVE.THE.ANTISPAM.WORDS.com"), "desc" => $template['tools']['tool2'], "url" => "ftp://ftp.kvirc.net/pub/kvirc/tools/kvirc-2.0.tcl.bz2"),

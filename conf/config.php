...
$themes=array(
	1 => array("name" => "Marble Theme", "version" => "1.0.4", "mail" => "sbrokka [at] openlug [dot] org", "author" => "Sbrokka", "desc" => $template['themes']['theme1'], "home" => "", "download" => "Marble-1.0.4.tar.bz2", "screen" => "theme_marble.jpg", "thumb" => "thumb_marble.png"),
	array("name" => "Crystal", "version" => "0.3.0", "mail" => "trisk-kvirc [at] quasarnet [dot] org", "author" => "Triskelios", "desc" => $template['themes']['theme2'], "home" => "", "download" => "Crystal-0.3.0.tar.bz2", "screen" => "theme_crystal.jpg", "thumb" => "thumb_crystal.png"),
	array("name" => "Green Theme", "version" => "1.1.0", "mail" => "", "author" => "F.F (have more fun)", "desc" => $template['themes']['theme3'], "home" => "", "download" => "Green-1.1.0.tar.gz", "screen" => "theme_green.jpg", "thumb" => "thumb_green.png"),
	array("name" => "Ircii Like", "version" => "1.0.0", "mail" => "eva [at] cyberbeat [dot] it", "author" => "Penny", "desc" => $template['themes']['theme4'], "home" => "", "download" => "ircii_like-1.0.0.tar.bz2", "screen" => "theme_ircii.jpg", "thumb" => "thumb_ircii.png"),
	array("name" => "Yisus", "version" => "0.3", "mail" => "fnotari [at] comtron.com [dot] ar", "author" => "Fernando Notari", "desc" => $template['themes']['theme5'], "home" => "", "download" => "yisus-0.3.tar.bz2", "screen" => "theme_notari.jpg", "thumb" => "thumb_notari.png"),
	array("name" => "Kitsch Theme", "version" => "1.0.0", "mail" => "eva [at] cyberbeat [dot] it", "author" => "Penny", "desc" => $template['themes']['theme6'], "home" => "", "download" => "Kitsch-1.0.0.tar.bz2", "screen" => "theme_kitsch.jpg", "thumb" => "thumb_kitsch.png"),
	array("name" => "Ghost", "version" => "1.0.0", "mail" => "darkstalker [at] insightbb [dot] com", "author" => "Jason Carter", "desc" => $template['themes']['theme7'], "home" => "", "download" => "Ghost-1.0.0.tar.bz2", "screen" => "theme_ghost.jpg", "thumb" => "thumb_ghost.png"),
	array("name" => "PayneReactor", "version" => "1.0.0", "mail" => "webmaster [at] paynereactor [dot] net", "author" => "Kristian Hollund", "desc" => $template['themes']['theme8'], "home" => "http://www.PayneReactor.com", "download" => "PayneReactor.tar.bz2", "screen" => "theme_payne.jpg", "thumb" => "thumb_payne.png"),
	array("name" => "XCrystall Black", "version" => "0.0.1", "mail" => "wizard at opendoor [dot] ru", "author" => "Alexey", "desc" => $template['themes']['theme9'], "home" => "", "download" => "xcrystall-0.0.1.tar.bz2", "screen" => "theme_xcrystall.jpg", "thumb" => "thumb_xcrystall.jpg"),
	array("name" => "DarkBaghira", "version" => "0.1.2", "mail" => "hellvis69 [at] netsons [dot] org", "author" => "HelLViS69", "desc" => $template['themes']['theme10'], "home" => "http://hellvis69.netsons.org", "download" => "DarkBaghira-0.1.2.tar.bz2", "screen" => "theme_darkbaghira.jpg", "thumb" => "thumb_darkbaghira.png"),
	array("name" => "Time makes no sense", "version" => "3.3.2", "mail" => "cle [at] virg0 [dot] org", "author" => "etherea`", "desc" => $template['themes']['theme11'], "home" => "http://kvirc.virg0.org", "download" => "Time-3.3.2.tar.bz2", "screen" => "theme_time.png", "thumb" => "thumb_time.png"),
	array("name" => "Pure", "version" => "1.0.1", "mail" => "cle [at] virg0 [dot] org", "author" => "etherea`", "desc" => $template['themes']['theme12'], "home" => "http://kvirc.virg0.org", "download" => "Pure-1.0.1.tar.bz2", "screen" => "theme_pure.png", "thumb" => "thumb_pure.png"),
	array("name" => "Dark Glass", "version" => "1.0.0", "mail" => "grifisx [at] barmes.org", "author" => "Grifisx &amp; Noldor", "desc" => $template['themes']['theme13'], "home" => "", "download" => "DarkGlass-1.0.tar.bz2", "screen" => "theme_darkglass.png", "thumb" => "thumb_darkglass.png"),
...
$tools=array(
	...
	array("name" => "GetText Checker", "author" => "aleksanteri", "mail" => "aleksanteri4028 [at] gmail [dot] com", "desc" => $template['tools']['tool4'], "url" => "ftp://ftp.kvirc.net/pub/kvirc/tools/gtc-1.0.tcl.bz2")
);

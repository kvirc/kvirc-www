...
$tools=array(
	...
	array("name" => "KVIrc TCL", "author" => "HelLViS69 &amp; CtrlAltCa", "mail" => "hellvis69@netsons.REMOVE.THE.ANTISPAM.WORDS.org", "desc" => $template['tools']['tool2'], "url" => "ftp://ftp.kvirc.net/pub/kvirc/tools/kvirc-2.0.tcl.bz2"),

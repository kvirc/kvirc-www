...
$themes=array(
	...
	array("name" => "mIRC", "version" => "2.0", "mail" => "sonichedgehog_hyperblast00 [at] yahoo [dot] com", "author" => "Taoki", "desc" => $template['themes']['theme28'], "home" => "", "download" => "mIRC-2.0.kvt", "screen" => "theme_mirc.png", "thumb" => "thumb_mirc.png"),
	...
	array("name" => "System", "version" => "2.0", "mail" => "sonichedgehog_hyperblast00 [at] yahoo [dot] com", "author" => "Taoki", "desc" => $template['themes']['theme33'], "home" => "", "download" => "System-2.0.kvt", "screen" => "theme_system.png", "thumb" => "thumb_system.png"),
	...
	array("name" => "VDark", "version" => "1.0.1", "mail" => "", "author" => "RoadRunner", "desc" => $template['themes']['theme40'], "home" => "", "download" => "VDark-1.0.1.kvt", "screen" => "theme_vdark.png", "thumb" => "thumb_vdark.png"),
	array("name" => "VLight", "version" => "1.0.2", "mail" => "", "author" => "RoadRunner", "desc" => $template['themes']['theme41'], "home" => "", "download" => "VLight-1.0.2.kvt", "screen" => "theme_vlight.png", "thumb" => "thumb_vlight.png")

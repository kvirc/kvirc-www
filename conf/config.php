...
$themes=array(
	1 => array("name" => "Marble Theme", "version" => "1.0.4", "mail" => "sbrokka [at] openlug [dot] org", "author" => "Sbrokka", "desc" => $template['themes']['theme1'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Marble-1.0.4.tar.bz2", "screen" => "theme_marble.jpg", "thumb" => "thumb_marble.png"),
	array("name" => "Crystal", "version" => "0.3.0", "mail" => "trisk-kvirc [at] quasarnet [dot] org", "author" => "Triskelios", "desc" => $template['themes']['theme2'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Crystal-0.3.0.tar.bz2", "screen" => "theme_crystal.jpg", "thumb" => "thumb_crystal.png"),
	...
	array("name" => "Ircii Like", "version" => "1.0.0", "mail" => "eva [at] cyberbeat [dot] it", "author" => "Penny", "desc" => $template['themes']['theme4'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/ircii_like-1.0.0.tar.bz2", "screen" => "theme_ircii.jpg", "thumb" => "thumb_ircii.png"),
	array("name" => "Yisus", "version" => "0.3", "mail" => "fnotari [at] comtron.com [dot] ar", "author" => "Fernando Notari", "desc" => $template['themes']['theme5'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/yisus-0.3.tar.bz2", "screen" => "theme_notari.jpg", "thumb" => "thumb_notari.png"),
	array("name" => "Kitsch Theme", "version" => "1.0.0", "mail" => "eva [at] cyberbeat [dot] it", "author" => "Penny", "desc" => $template['themes']['theme6'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Kitsch-1.0.0.tar.bz2", "screen" => "theme_kitsch.jpg", "thumb" => "thumb_kitsch.png"),
	array("name" => "Ghost", "version" => "1.0.0", "mail" => "darkstalker [at] insightbb [dot] com", "author" => "Jason Carter", "desc" => $template['themes']['theme7'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Ghost-1.0.0.tar.bz2", "screen" => "theme_ghost.jpg", "thumb" => "thumb_ghost.png"),
	array("name" => "PayneReactor", "version" => "1.0.0", "mail" => "webmaster [at] paynereactor [dot] net", "author" => "Kristian Hollund", "desc" => $template['themes']['theme8'], "home" => "http://www.PayneReactor.com", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/PayneReactor.tar.bz2", "screen" => "theme_payne.jpg", "thumb" => "thumb_payne.png"),
	array("name" => "XCrystall Black", "version" => "0.0.1", "mail" => "wizard at opendoor [dot] ru", "author" => "Alexey", "desc" => $template['themes']['theme9'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/xcrystall-0.0.1.tar.bz2", "screen" => "theme_xcrystall.jpg", "thumb" => "thumb_xcrystall.jpg"),
	array("name" => "DarkBaghira", "version" => "0.1.2", "mail" => "hellvis69 [at] netsons [dot] org", "author" => "HelLViS69", "desc" => $template['themes']['theme10'], "home" => "http://hellvis69.netsons.org", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/DarkBaghira-0.1.2.tar.bz2", "screen" => "theme_darkbaghira.jpg", "thumb" => "thumb_darkbaghira.png"),
	array("name" => "Time makes no sense", "version" => "3.3.2", "mail" => "cle [at] virg0 [dot] org", "author" => "etherea`", "desc" => $template['themes']['theme11'], "home" => "http://kvirc.virg0.org", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Time-3.3.2.tar.bz2", "screen" => "theme_time.png", "thumb" => "thumb_time.png"),
	array("name" => "Pure", "version" => "1.0.1", "mail" => "cle [at] virg0 [dot] org", "author" => "etherea`", "desc" => $template['themes']['theme12'], "home" => "http://kvirc.virg0.org", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Pure-1.0.1.tar.bz2", "screen" => "theme_pure.png", "thumb" => "thumb_pure.png"),
	array("name" => "Dark Glass", "version" => "1.0.0", "mail" => "grifisx [at] barmes.org", "author" => "Grifisx &amp; Noldor", "desc" => $template['themes']['theme13'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/DarkGlass-1.0.tar.bz2", "screen" => "theme_darkglass.png", "thumb" => "thumb_darkglass.png"),
	array("name" => "Black Heart", "version" => "1.0.0", "mail" => "grifisx [at] barmes.org", "author" => "Grifisx &amp; Noldor", "desc" => $template['themes']['theme14'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/BlackHeart-1.0.tar.bz2", "screen" => "theme_blackheart.png", "thumb" => "thumb_blackheart.png"),
	array("name" => "X-KVIrc-mas", "version" => "1.0.0", "mail" => "grifisx [at] barmes.org", "author" => "Grifisx &amp; Noldor", "desc" => $template['themes']['theme15'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/X-KVIrcmas-1.0.tar.bz2", "screen" => "theme_X-KVIrcmas.png", "thumb" => "thumb_X-KVIrcmas.png"),
	array("name" => "Words are Perversion", "version" => "1.0.3", "mail" => "cle [at] virg0 [dot] org", "author" => "etherea`", "desc" => $template['themes']['theme16'], "home" => "http://kvirc.virg0.org", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Words_are_Perversion-1.0.tar.bz2", "screen" => "theme_words.png", "thumb" => "thumb_words.png"),
	array("name" => "erotica", "version" => "0.6.9", "mail" => "cle [at] virg0 [dot] org", "author" => "etherea`", "desc" => $template['themes']['theme17'], "home" => "http://kvirc.virg0.org", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/erotica-0.6.9.rar", "screen" => "theme_erotica.png", "thumb" => "thumb_erotica.png"),
	array("name" => "Anger", "version" => "0.0.1", "mail" => "cle [at] virg0 [dot] org", "author" => "etherea`", "desc" => $template['themes']['theme18'], "home" => "http://kvirc.virg0.org", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Anger-0.0.1.rar", "screen" => "theme_anger.png", "thumb" => "thumb_anger.png"),
	array("name" => "Dark Blue", "version" => "0.9.0", "mail" => "lgxco [at] yahoo [dot] it", "author" => "Puk", "desc" => $template['themes']['theme19'], "home" => "", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/DarkBlue-0.9.0.kvt", "screen" => "theme_darkblue.png", "thumb" => "thumb_darkblue.png"),
	array("name" => "Soft Blue", "version" => "2.0", "mail" => "gestenigd [at] gmail [dot] com", "author" => "lsd", "desc" => $template['themes']['theme20'], "home" => "http://stato-brodo.blogspot.com", "download" => "ftp://ftp.kvirc.net/pub/kvirc/themes/Soft_blue-2.0.kvt", "screen" => "theme_softblue.jpg", "thumb" => "thumb_softblue.jpg")
);

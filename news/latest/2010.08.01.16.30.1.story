...
<p>Here we go again: 4.0.2 is ready.</p>

<p>This is mainly a bugfix release. 4.0.0 went public after a very long delay and
...
patch for a security issue related to DCC handshakes (secunia advisory SA40727).</p>

<p>Configuration from existing 4.0.0 installations will be completly preserved

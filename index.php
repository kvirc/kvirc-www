					...
					<ul>
						<li><a href="#"><?=$template['index']['running']?></a>
							<ul>
								...
								<li><a href="?id=git&amp;lang=<?=$lang?>"><?=$template['index']['git']?></a></li>
					...
					<ul>
						<li><a href="#"><?=$template['index']['docs']?></a>
							<ul>
								...
								<li><a href="javascript:opendoc('https://github.com/kvirc/KVIrc/wiki/FAQ');"><?=$template['index']['faq2']?></a></li>
								...
								<li><a href="javascript:opendoc('https://github.com/kvirc/KVIrc/wiki/Keyboard-shortcuts');"><?=$template['index']['shortcuts']?></a></li>
							</ul>
						</li>
					</ul>
					<ul>
					...
					<ul>
						<li><a href="#"><?=$template['index']['contact']?></a>
							<ul>
								...
								<li><a href="javascript:opendoc('https://github.com/kvirc/KVIrc/issues');" title="KVIrc bugtrack"><?=$template['index']['bugtrack']?></a></li>
							</ul>
						</li>
					</ul>
					<ul>
		...
		<div class="main">
			<div class="main-navigation">
				...
				<dl class="nav3-grid">
					...
					for($i = 0; $i < 10; $i++):
						...
						?>
						<dt><a href="?id=news&amp;story=<?=basename($latestnews[$i])?>&amp;dir=latest&amp;lang=<?=$lang?>"><?=$news?></a></dt>
					<?php endfor; ?>
					<dt><a href="?id=news&amp;dir=latest&amp;lang=<?=$lang?>"><?=$template['index']['allnews']?></a></dt>
				</dl>
				...
				<p>
					<?php foreach($www_mirror as $key => $value): ?>
						<a href="<?=$value['url']?>" class="info"><?=$value['name']?><span><br /><?=$value['desc']?><br /><?=$template['custom']['city']?>: <?=$value['city']?><br /><?=$template['custom']['maintainer']?>: <?=$value['maintainer']?></span></a><br />
					<?php endforeach; ?>
				</p>
				...
				<p><br />
					<?=$template['index']['mirrorstext1a']?> <a href="?id=mirroring&amp;lang=<?=$lang?>" title="<?=$template['index']['mirrorstitle']?>"><?=$template['index']['mirrorstext1b']?></a> <?=$template['index']['mirrorstext1c']?><br />
					<?=$template['index']['mirrorstext2']?>
				</p>
			...
			<div class="main-subcontent">
				...
				<div class="subcontent-unit-border-orange">
					...
					<p class="center">
						<?=$template['index']['bugstext']?> <a href="javascript:opendoc('https://github.com/kvirc/KVIrc/issues');" title="<?=$template['index']['bugtrack']?>"><?=$template['index']['bugtrack']?></a>
					</p>
				</div>
				<div class="subcontent-unit-border">
					<div class="round-border-topleft"></div>
				...
				<div class="subcontent-unit-border-white">
					...
					<p class="center">
						...
						<?php if(getHostKvircde()): ?>
							<?=$template['index']['donationtextkvirc.de']?>
						<?php endif; ?>
					</p>
				</div>
				<div class="subcontent-unit-border-white">

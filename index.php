		...
		<div class="main">
			...
			<div class="main-subcontent">
				...
				<div class="subcontent-unit-border">
					...
					<p class="center">
						<?php echo $template['index']['helptext1a']." <a href=\"?id=mailinglist&amp;lang=$lang\" title=\"".$template['index']['helptext1b']."\">".$template['index']['helptext1b']."</a><br /><br />".$template['index']['helptext1c']."<br />";?>
				...
				<div class="subcontent-unit-border-white">
					...
					<p class="center">
						...
						<?php if(getHostKvircde()) echo " ".$template['index']['donationtextkvirc.de'];?>
					</p>
				</div>
				<div class="subcontent-unit-border-white">
					<div class="round-border-topleft"></div><div class="round-border-topright"></div>
